...
<template>
  <main class="home">
      ...
      <div class="hero__content container">
        ...
        <div class="hero__actions">
          <template v-if="isAuthenticated">
            <RouterLink to="/diary" class="btn btn-primary btn-lg">Zum Diary</RouterLink>
            <RouterLink to="/public" class="hero__secondary">Public Feed ansehen →</RouterLink>
          </template>
          <template v-else>
    ...
    <section class="cta container">
      <template v-if="isAuthenticated">
        <h2>Bereit für deinen nächsten Eintrag?</h2>
        <RouterLink to="/diary" class="btn btn-primary btn-lg">Zum Diary</RouterLink>
      </template>
      <template v-else>
